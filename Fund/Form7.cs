...
namespace Fund
{
    ...
    {
        List<StockContent_2> stock2 = new List<StockContent_2>();
        List<StockContent_2> stock3 = new List<StockContent_2>();
        ...
        void GetIntroduction()
        {
            ...
            if (!data.Contains("市场"))
            {
                ...
                {
                    StockContent_2 temp = new StockContent_2();
            ...
            List<StockContent_2> result = new List<StockContent_2>();
            foreach (var element in stock2)
            {
                int count = stock3.Count;
                for (int i = 0; i < count; i++)
                {
                    if (element.name == stock3[i].name)
                    {
                        element.num = (Convert.ToDouble(stock3[i].num)- Convert.ToDouble(element.num)).ToString();
                        result.Add(element);
                        stock3.RemoveAt(i);
                        break;
                    }
